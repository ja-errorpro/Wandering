...
class _GeneratedLoadingPageState extends State<GeneratedLoadingPage> {
  ...
  Future<void> _loadItinerary() async {
    ...
    final Map<String, List<ItineraryItem>> sampleDailyItinerary = {
      "第一天 (10月27日)": [ // 日期字串可以包含實際日期
        ItineraryItem(name: '抵達桃園機場', arrivalTime: '10:00', activityDuration: '1 小時'),
        ItineraryItem(name: '搭乘機場捷運前往台北市區', arrivalTime: '11:30', activityDuration: '1 小時', transportationToNext: '機場捷運', transportationDuration: '40 分鐘'),
        ItineraryItem(name: '飯店 Check-in & 放行李', arrivalTime: '12:30', activityDuration: '30 分鐘'),
        ItineraryItem( // 用餐項目，包含餐廳名稱和推薦品項
          name: '午餐 - 台北特色牛肉麵',
          arrivalTime: '13:00',
        ...
        ItineraryItem( // 用餐項目，只包含餐廳名稱 (沒有推薦品項)
          name: '晚餐 - 永康街小吃',
          arrivalTime: '19:00',
          activityDuration: '1.5 小時',
        ...
        ItineraryItem(name: '逛信義商圈看夜景', arrivalTime: '21:00', activityDuration: '2 小時', transportationToNext: '捷運', transportationDuration: '20 分鐘'),
      ],
      "第二天 (10月28日)": [
        ItineraryItem( // 用餐項目 (早餐通常沒有推薦品項)
          name: '飯店享用早餐',
          arrivalTime: '08:00',
        ...
        ItineraryItem(name: '搭乘捷運回飯店', arrivalTime: '19:30', activityDuration: '40 分鐘', transportationToNext: '捷運', transportationDuration: '30 分鐘'),
      ],
      "第三天 (10月29日)": [ // 增加第三天，但沒有住宿，展示只有行程的情況
        ItineraryItem(name: '早餐', arrivalTime: '08:30', activityDuration: '1 小時'),
        ItineraryItem(name: '逛迪化街年貨大街 (如果時間對)', arrivalTime: '10:00', activityDuration: '2 小時', transportationToNext: '捷運', transportationDuration: '15 分鐘'),
        ItineraryItem( // 用餐項目
          name: '午餐 - 迪化街小吃',
          arrivalTime: '12:30',
          activityDuration: '1 小時',
        ...
        ItineraryItem(name: '最後採購', arrivalTime: '13:30', activityDuration: '1.5 小時'),
